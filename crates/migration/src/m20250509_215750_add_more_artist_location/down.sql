ALTER TABLE
  artist RENAME COLUMN current_location_country TO location_country;

ALTER TABLE
  artist RENAME COLUMN current_location_province TO location_province;
...
ALTER TABLE
  artist_history RENAME COLUMN current_location_country TO location_country;

ALTER TABLE
  artist_history RENAME COLUMN current_location_province TO location_province;
