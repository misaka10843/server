...
ADD CONSTRAINT "fk_image_uploaded_by" FOREIGN KEY ("uploaded_by") REFERENCES "public"."user" ("id");
...
CREATE TABLE
	"public"."artist_localized_name_history" (
		"id" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
		"history_id" INTEGER NOT NULL REFERENCES "public"."artist_history" ("id"),
		"language_id" INTEGER NOT NULL REFERENCES "public"."language" ("id"),
		"name" TEXT NOT NULL,
...
CREATE TRIGGER update_comment_updated_at BEFORE INSERT
OR
UPDATE ON "public"."comment" FOR EACH ROW
EXECUTE FUNCTION update_updated_at ();

-- Create "comment_revision" table
CREATE TABLE
	"public"."comment_revision" (
		"id" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE
	"public"."credit_role_inheritance" (
...
CREATE TABLE
	"public"."credit_role_inheritance_history" (
...
CREATE TABLE
	"public"."event_alternative_name_history" (
		"id" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE
	"public"."group_member_role_history" (
		"group_member_history_id" INTEGER NOT NULL REFERENCES "public"."group_member_history" ("id"),
		"role_id" INTEGER NOT NULL REFERENCES "public"."credit_role" ("id"),
...
CREATE TABLE
	"public"."label_localized_name_history" (
		"history_id" INTEGER NOT NULL REFERENCES "label_history" ("id"),
		"language_id" INTEGER NOT NULL REFERENCES "language" ("id"),
		"name" TEXT NOT NULL,
...
CREATE TABLE
	"public"."release_localized_title" (
		"release_id" INTEGER NOT NULL REFERENCES "public"."release" ("id"),
		"language_id" INTEGER NOT NULL REFERENCES "public"."language" ("id"),
		"title" TEXT NOT NULL,
...
CREATE TABLE
	"public"."release_localized_title_history" (
		"history_id" INTEGER NOT NULL REFERENCES "public"."release_history" ("id"),
		"language_id" INTEGER NOT NULL REFERENCES "public"."language" ("id"),
		"title" TEXT NOT NULL,
...
CREATE TABLE
	"public"."release_track_artist_history" (
...
CREATE TABLE
	"public"."song_localized_title_history" (
		"id" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
		"history_id" INTEGER NOT NULL REFERENCES "public"."song_history" ("id"),
		"language_id" INTEGER NOT NULL REFERENCES "public"."language" ("id"),
		"title" TEXT NOT NULL,
...
CREATE TABLE
	"public"."tag_alternative_name_history" (
		"id" INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
