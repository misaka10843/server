...
pub enum FileImageStorageError {
    #[api_error(
...
pub static FILE_IMAGE_STORAGE: LazyLock<FileImageStorage> =
    LazyLock::new(|| FileImageStorage::new(&DEFAULT_PATH));
...
impl AsyncImageStorage for FileImageStorage {
    type File = tokio::fs::File;
    type CreateError = FileImageStorageError;
